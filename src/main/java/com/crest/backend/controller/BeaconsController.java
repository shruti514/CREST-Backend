...
public class BeaconsController {
    ...
    public @ResponseBody String programABC() throws IOException {
        return "testStringIsWorking";
    }

    @RequestMapping(value="/station/{beaconId}",method=RequestMethod.GET)
    public @ResponseBody CrestResponse getStationFromBeaconID(@PathVariable("beaconId") String beaconId) throws Exception
    {
    ...
    public @ResponseBody CrestResponse getStationFromBeaconID(@PathVariable("busStopId1") String busStopId1, @PathVariable("busStopId2") String busStopId2) throws Exception
    {
